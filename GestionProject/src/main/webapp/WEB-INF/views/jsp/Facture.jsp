...
<body>
	<f:form method="post" modelAttribute="xx" action="choix">
...
<c:forEach items="${liste}" var="produit">
						...
						<th></th>
							...
							<c:if test="${produit.tva == 18}">
							<td><div id="inputch">    <input type="text" id="check_data" ></div></td>
							</c:if>
								<c:if test="${produit.tva == 12}">
							<td><div id="inputch">    <input type="text"  value="1."   readonly="readonly"></div></td>
							</c:if>
							
				
<td ><div id="testCheck">       <input type="checkbox"  value="${produit.id}${produit.tva}" />    </div> </td>
