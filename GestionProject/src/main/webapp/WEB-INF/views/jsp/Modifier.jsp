...
<body>
	...
	<f:form method="post" modelAttribute="produit" action="update">

<f:input type="hidden" path="id" 
							class=" styleInput  code required uni"
							 />
							<img src="resources/css/header.png" style="width: 100%"></img>
							 
<table class="table table-striped table table-hover table-bordered ">
		<tr><td><button type="submit" id="onhold" class="button" name="modif"
							 >Enregistrer</button>
							<button type="submit" id="return" name="menu"  class="button" style="margin-left: 2%"
							>Retour
						</button> 
						 </td>
